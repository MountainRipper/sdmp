/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.34 on Wed Dec  9 10:08:39 2020.
...
int open_gl(void) {
    ...
    const char* glGetFunction = "eglGetProcAddress";
#else
    static const char *NAMES[] = {"libGL.so.1", "libGL.so"};
    const char* glGetFunction = "glXGetProcAddressARB";
#endif
#endif
