/*
    ...
    EGL loader generated by glad 0.1.34 on Wed Dec  9 10:27:23 2020.
...
static void load_EGL_KHR_image(GLADloadproc load) {
    ...
    if(glad_eglCreateImageKHR == NULL)
        glad_eglCreateImageKHR = (PFNEGLCREATEIMAGEKHRPROC)load("eglCreateImage");
    if(glad_eglDestroyImageKHR == NULL)
        glad_eglDestroyImageKHR = (PFNEGLDESTROYIMAGEKHRPROC)load("eglDestroyImage");
}
