...
oo.class("Synthesis", Graph)
Publisher.layer = '__layer_synthesis'
...
function Synthesis:init()
        Synthesis.super.init(self)
...
function Synthesis:callNative(name,param)
        return luaCallNative(nativeContext,name, param)
end

function Synthesis:onConnectEvent()
